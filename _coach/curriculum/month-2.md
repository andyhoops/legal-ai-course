...
Month 1 was about discovery. Month 2 is about rigour. The student starts asking harder questions, building multi-step conversations, and — crucially — learning to interrogate what Claude tells them. This is where critical thinking becomes the main skill.

By the end of Month 2 the student will:
...
- Have their GitHub repo set up with the first commits pushed
...
### Legal content
- Revisit any topic from Weeks 1–7 where the student had doubts
- Introduce AI hallucination: why language models sometimes state false things confidently
...
### Session activities
1. Deliberately ask Claude a question where you already know the answer (from Months 1–7) and check whether it's right
...
### Facilitator notes
- This is the most important conceptual week of the course
- The goal is not to make the student distrust Claude but to build healthy epistemic habits
- End-of-month check: student should now have GitHub repo live with Month 1 journal entries pushed; prompt library started with at least 5 entries
